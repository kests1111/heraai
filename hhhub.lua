...
do  
    ...
    -- УДАЛЕНО: Вся система проверки luamor
    -- Теперь скрипт загружается автоматически без проверки ключа
    local do_check_key = function(key)
        ...
        StarterGui:SetCore("SendNotification",{
            Title = "Key System",
            Text = "[KEY_VALID] Ключ принят! Скрипт загружается...",
        ...
        -- Просто загружаем скрипт без проверки luamor
        wait(.25)
